...
componentWillReceiveProps(nextProps){
  ...
  if(nextProps.location.state != null){
      ...
      this.setState({
      /* class: nextProps.location.state.detail.standard,
      section: nextProps.location.state.detail.section,
      subject: nextProps.location.state.detail.subject,
      title: nextProps.location.state.detail.title,
      description: nextProps.location.state.detail.content, */
  ...
  return (
      <Formik
          ...
          onSubmit={fields => {
             ...
             /*  axios.get(`http://54.187.114.170:81/api/activeUsers?page=${this.state.pNo}`)params: { answer: 42 }
              .then(res => {
                  console.log(res);
              }) */
          ...
          render={({ errors, status, touched }) => (
              <Form>
                  <div className="form-group">
                      ...
                      <Field name="first_name" type="text" value = {this.state.first_name} className={'form-control' + (errors.first_name && touched.first_name ? ' is-invalid' : '')} />
                  ...
                  {/* <div className="form-group">
                      ...
                      <Field name="campus" type="text" className={'form-control' + (errors.campus && touched.campus ? ' is-invalid' : '')} />  
                      <ErrorMessage name="campus" component="div" className="invalid-feedback" /> 
                  </div> */}
                  <div className="form-group">
              ...
              <option>Choose Subject</option>
                  {
                      this.state.subjects.map((sub,index) => (
                          <option  key={index}> {sub.subject_name}</option>
                      ))
                  }
